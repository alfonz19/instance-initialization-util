...
public class PathComponentsTest {
    ...
    public void testTopLevelArray() {
        PathComponents pathComponents = new PathComponents(".[1]");
        assertArrayIndex(pathComponents.getLastPathComponent(), 1);
    ...
    @Test
    public void testTopLevelAssociativeArray() {
        PathComponents pathComponents = new PathComponents(".[\"abc\"]");
        assertAssociativeArrayKey(pathComponents.getLastPathComponent(), "\"abc\"");
    ...
    @Test(expected = InitializeException.class)
    public void testIncorrectPath10() {
        new PathComponents(".[]");
    }
    ...
    public void assertAssociativeArrayKey(PathComponent component, String key) {
        assertThat(component, notNullValue());
        assertThat(component.getValue(), is(key));
        assertThat(component.getPathComponentType(), is(PathComponentType.MAP_KEY));
    }
}